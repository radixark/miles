...
class TestRegisterRank:
    ...
    async def test_new_run_id_updates_state(self) -> None:
        ...
        assert harness.controller._training_rank_roster.run_id == "run-1"
    ...
    async def test_same_run_id_same_rank_updates(self) -> None:
        ...
        assert harness.controller._training_rank_roster.rank_placement[0] == "node-0-new"
    ...
    async def test_partial_registration_tick_still_runs(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        assert len(harness.controller._training_rank_roster.rank_placement) == 3
        assert 3 not in harness.controller._training_rank_roster.rank_placement
        assert harness.controller._training_rank_roster.expected_world_size == 4
    ...
    async def test_full_registration_no_warning(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        assert harness.controller._training_rank_roster.expected_world_size == 4
        assert len(harness.controller._training_rank_roster.rank_placement) == 4
    ...
    async def test_expected_world_size_reset_on_new_run(self) -> None:
        ...
        assert harness.controller._training_rank_roster.expected_world_size == 8
    ...
    async def test_register_rank_stores_pid(self) -> None:
        ...
        assert harness.controller._training_rank_roster.rank_pids == {0: 1234}
    ...
    async def test_new_run_id_clears_rank_pids(self) -> None:
        ...
        assert harness.controller._training_rank_roster.rank_pids == {0: 5678}
...
class TestGetRankPidsForNode:
    ...
    async def test_returns_pids_for_matching_node(self) -> None:
        ...
        result = harness.controller._training_rank_roster.get_rank_pids_for_node("node-0")
    ...
    async def test_returns_empty_for_unknown_node(self) -> None:
        ...
        result = harness.controller._training_rank_roster.get_rank_pids_for_node("node-999")
        assert result == {}
...
class TestLogStep:
    ...
    async def test_log_step_no_active_run(self) -> None:
        ...
        assert harness.controller._training_rank_roster.run_id is None
        assert harness.mini_wandb.latest(metric_name="loss") is None
