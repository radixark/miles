...
CKPT_ARGS=(
   --hf-checkpoint /root/.cache/modelscope/hub/models/Qwen/Qwen3-0___6b
   #--hf-checkpoint /root/Qwen3-4B-FP8
   --ref-load /root/Qwen/Qwen3-0.6b
   --load /root/Qwen/Qwen3-0.6b_miles/
   --save /root/Qwen/Qwen3-0.6b_miles/
   --save-interval 20
)
