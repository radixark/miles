...
ACTOR_NUM_GPUS = NUM_GPUS - ROLLOUT_NUM_GPUS  # 6: training actor pool (rdt keeps it disjoint from rollout)
...
def execute():
    ...
    # rdt weight update is incompatible with --colocate, so actor and rollout use
