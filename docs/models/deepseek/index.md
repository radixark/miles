...
See the [DeepSeek-V4 Flash](/models/deepseek/deepseek-v4-flash) page for the V4 architecture summary, parallelism layouts, and known workarounds. See the [DeepSeek-V3.2](/models/deepseek/deepseek-v3-2) page for the V3.2 flow — FP8 → BF16 conversion, the TP2 / PP4 / EP16 training layout, the NSA rollout settings, and the FP8 / MXFP8 options.

## Pairs well with

- [FP8 & Low Precision](/advanced/low-precision) — both generations ship FP8 checkpoints and optional low-precision rollout.
