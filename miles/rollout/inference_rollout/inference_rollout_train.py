...
async def generate_rollout_async(
    ...
    while len(data) < target_data_size:
        ...
        for task in done:
            ...
            if not dynamic_filter_output.keep:
                ...
                SampleOwnershipRecorder.log_dropped_groups(group, [], reason="dynamic_filter", rollout_id=rollout_id)
                continue
    ...
    SampleOwnershipRecorder.log_dropped_groups(
        before_filter, data, reason="rollout_sample_filter", rollout_id=rollout_id
    )
