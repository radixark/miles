...
class TestConvertSamplesToTrainData:
    def test_repeated_source_sample_gets_distinct_row_identities(self):
        """Expanded rows retain their source sample and stable row ordinal."""
        ...
        assert out["sample_row_indices"] == [0, 1, 0]
        assert out["sample_row_counts"] == [2, 2, 1]
