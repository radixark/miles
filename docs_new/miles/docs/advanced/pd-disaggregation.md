...
* [DeepSeek R1 recipe](/miles/docs/models/deepseek/deepseek). PD is a clear win at
  671B scale.
* [Speculative decoding](/miles/docs/advanced/speculative-decoding). Both are SGLang-side
