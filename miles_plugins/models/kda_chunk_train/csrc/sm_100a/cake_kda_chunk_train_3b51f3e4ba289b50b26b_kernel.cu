...
kernel_cake_kda_chunk_train_3b51f3e4ba289b50b26b(CakeTensorMap const* akk_tma, CakeTensorMap const* vb_tma, CakeTensorMap const* kb_tma, __nv_bfloat16* __restrict__ u_out, __nv_bfloat16* __restrict__ w_out, int num_heads)
{
