...
from miles.utils.chat_template_utils.message_matcher_hub import (
    assert_messages_append_only_with_allowed_role as _assert_messages_append_only_with_allowed_role,
)
from miles.utils.chat_template_utils.message_matcher_hub import message_matches as _message_matches

assert_messages_append_only_with_allowed_role = _assert_messages_append_only_with_allowed_role
message_matches = _message_matches
