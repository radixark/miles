...
from miles.ray.specs.inference import compute_engine_spec_names, compute_router_spec_name
...
async def _init_controller(args) -> InferenceController:
    ...
    controller = InferenceController(
        ...
        router_provider=capability.static_worker_provider(spec_name=compute_router_spec_name(0)),
    )
