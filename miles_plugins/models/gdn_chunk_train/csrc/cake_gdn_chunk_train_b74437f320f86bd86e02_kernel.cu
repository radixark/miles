...
kernel_cake_gdn_chunk_train_b74437f320f86bd86e02(int* __restrict__ cu_seqlens, int* __restrict__ chunk_start, int* __restrict__ chunk_len, int* __restrict__ seq_chunk_start, int num_seqs, int num_chunks_max, int total_tokens)
{
