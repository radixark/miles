...
from miles.utils.audit_utils.process_identity import MultiLoRAControllerProcessIdentity
...
class MultiLoRAController:
    def __init__(self, *, args, router_provider: BaseWorkerProvider, host: str = "0.0.0.0") -> None:
        configure_logger(args, source=MultiLoRAControllerProcessIdentity())
