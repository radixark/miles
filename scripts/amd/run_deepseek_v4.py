...
def _prepare_spmd(args: ScriptArgs):
    ...
    extra_args = "--model-impl miles --expert-tensor-parallel-size 1 --context-parallel-size 1 "
...
def _train(args: ScriptArgs):
    ...
    misc_args = (
        ...
        "--model-impl miles "  # ROCm has no cudnn/flash_mla path for the megatron impl
