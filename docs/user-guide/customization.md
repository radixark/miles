...
- The built-in source checkpoints sample identity cursors even when the global dataset is disabled.
- The legacy buffered source also checkpoints pending partial-rollout groups.
