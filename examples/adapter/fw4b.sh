...
#    --prompt-data /root/dapo-math-17k/dapo-math-17k.jsonl
   --prompt-data /root/miles/examples/adapter/math/gsm8k.jsonl
   --input-key prompt
   --label-key label
#    --rollout-shuffle
   --rm-type deepscaler
...
CUSTOM_ARGS=(
   --custom-generate-function-path examples.adapter.fireworks_wrapper.generate
   --custom-reward-path examples.adapter.math.gsm8k_evaluator.gsm8k_reward_row
