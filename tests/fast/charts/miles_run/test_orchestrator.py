...
WRAPPER_MODULE = "miles.utils.external_utils.command_utils.helm_backend.orchestrator_wrapper"
...
class TestOrchestrator:
    def test_wraps_the_training_command_so_the_exit_code_reaches_shared_storage(self):
        ...
        assert command == [
            ...
            WRAPPER_MODULE,
            "--exit-file",
            f"/cluster-storage/miles_data/miles-runs/{RUN_ID}/state/orchestrator.exit",
            "--",
            "python",
            "train.py",
            "--foo",
