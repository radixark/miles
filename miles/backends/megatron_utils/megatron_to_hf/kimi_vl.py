...
def convert_language_model_to_hf(args, name, param):
    ...
    if match:
        ...
        if match:
            ...
            if rest == "linear_fc2":
                return [(f"language_model.model.layers.{layer_idx}.mlp.experts.{expert_idx}.down_proj.weight", param)]
        ...
        if rest == "self_attention.linear_q_proj.weight":
        ...
        if rest == "self_attention.linear_q_up_proj.layer_norm_weight":
            return [(f"language_model.model.layers.{layer_idx}.self_attn.q_a_layernorm.weight", param)]
        if rest == "self_attention.linear_q_up_proj.weight":
        ...
        if rest == "self_attention.linear_qkv.layer_norm_weight" or rest == "input_layernorm.weight":
        ...
        if rest == "self_attention.linear_kv_down_proj.weight":
            return [(f"language_model.model.layers.{layer_idx}.self_attn.kv_a_proj_with_mqa.weight", param)]
        if rest == "self_attention.linear_kv_up_proj.layer_norm_weight":
