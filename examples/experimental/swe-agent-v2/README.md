...
<!-- Append to examples/experimental/swe-agent-v2/README.md -->

## Qwen3 / Qwen3-Coder (and ROCm/AMD notes)

`run-qwen3-swe.py` runs the same pipeline with Qwen3 instead of GLM-4.7-Flash. It reuses
`run.py` and only swaps the model + SGLang/TITO parsers (`qwen25` / `qwen3` / `tito-model
qwen3`).
