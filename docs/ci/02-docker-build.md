...
| `KUBECTL_VERSION` / `HELM_VERSION`                                                                     | the Kubernetes clients installed into `/usr/local/bin`, verified against the published checksums. Both sit below the pip layers so a bump rebuilds nothing else                                                                                                                                                                                      |
