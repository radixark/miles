...
kernel_cake_kda_chunk_train_4e8343b3f3580cbb31c8(float* __restrict__ dAqk, float* __restrict__ dAkk, float* __restrict__ gk, __nv_bfloat16* __restrict__ k_e, __nv_bfloat16* __restrict__ q_e, float* __restrict__ beta, float* __restrict__ dq_f, float* __restrict__ dk_f, float* __restrict__ dg_f, float* __restrict__ db_f, float* __restrict__ q_rstd, float* __restrict__ k_rstd, int* __restrict__ chunk_bos, int* __restrict__ chunk_len, __nv_bfloat16* __restrict__ dq_ext, __nv_bfloat16* __restrict__ dk_ext, float* __restrict__ dg_out, float* __restrict__ db_out, int num_heads, int num_qk_heads, int group)
{
