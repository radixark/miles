...
def make_pod(
    ...
    **kwargs,
    ...
    pod_labels = {
        helm_labels.DEFAULT_LABEL_KEYS.pool_id: pool_id,
        helm_labels.DEFAULT_LABEL_KEYS.cell_index: cell_id_suffix,
        helm_labels.DEFAULT_LABEL_KEYS.pod_index: pod_index,
    }
...
class TestParsePod:
    ...
    def test_ignores_a_pod_that_names_no_pool(self):
        ...
        pod = make_unlabelled_pod("engine-0-0", labels={helm_labels.DEFAULT_LABEL_KEYS.cell_index: "0"})
    ...
    def test_reads_how_many_pods_the_cell_should_have(self):
        ...
        pod = make_pod(labels={helm_labels.DEFAULT_LABEL_KEYS.cell_size: "4"})
    ...
    def test_reads_the_domain_facts_a_platform_attached(self):
        ...
        pod = make_pod(
            annotations={f"{helm_labels.DEFAULT_LABEL_KEYS.meta_annotation_prefix}model_id": "glm", "other": "ignored"}
        )
    ...
    def test_reads_the_gpus_the_platform_assigned(self):
        ...
        pod = make_pod(
            annotations={
                f"{helm_labels.DEFAULT_LABEL_KEYS.meta_annotation_prefix}{helm_labels.DEFAULT_LABEL_KEYS.gpu_ids_meta}": "0,1,2,3"
            }
        )
...
class TestParsePods:
    def test_returns_the_pods_of_a_cell_in_index_order(self):
        ...
        assert [pod.pod_index for pod in pod_view.parse_pods(raw, keys=DEFAULT_LABEL_KEYS)] == [0, 1, 2]
