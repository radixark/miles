...
MODULES = {
    "prep": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_72f262735fdac648a5a4_kernel.cu",
                "sm_100a/cake_kda_chunk_train_72f262735fdac648a5a4_binding.cu",
            ),
            "block": (1024, 1, 1),
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_04552a349834008d18cf_kernel.cu",
                "sm_103a/cake_kda_chunk_train_04552a349834008d18cf_binding.cu",
            ),
            "block": (1024, 1, 1),
            "dynamic_smem_bytes": 4096,
            "tma_workspace_bytes": 0,
    ...
    "wy": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_365cc414e3ad612e9634_kernel.cu",
                "sm_100a/cake_kda_chunk_train_365cc414e3ad612e9634_binding.cu",
            ),
            "block": (192, 1, 1),
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_d32d54edcf58e0ee45f5_kernel.cu",
                "sm_103a/cake_kda_chunk_train_d32d54edcf58e0ee45f5_binding.cu",
            ),
            "block": (192, 1, 1),
            "dynamic_smem_bytes": 99328,
            "tma_workspace_bytes": 384,
    ...
    "fwdh": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_f058bceb35ac77dd8277_kernel.cu",
                "sm_100a/cake_kda_chunk_train_f058bceb35ac77dd8277_binding.cu",
            ),
            "block": (192, 1, 1),
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_6d7d29fb2f4abc9f0dcf_kernel.cu",
                "sm_103a/cake_kda_chunk_train_6d7d29fb2f4abc9f0dcf_binding.cu",
            ),
            "block": (192, 1, 1),
            "dynamic_smem_bytes": 91136,
            "tma_workspace_bytes": 256,
    ...
    "dav": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_efd1f91318b9eb777c56_kernel.cu",
                "sm_100a/cake_kda_chunk_train_efd1f91318b9eb777c56_binding.cu",
            ),
            "block": (192, 1, 1),
            "dynamic_smem_bytes": 99328,
            "tma_workspace_bytes": 384,
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_45f943d52b2424e3267d_kernel.cu",
                "sm_103a/cake_kda_chunk_train_45f943d52b2424e3267d_binding.cu",
            ),
            "block": (192, 1, 1),
            "dynamic_smem_bytes": 99328,
            "tma_workspace_bytes": 384,
    ...
    "dhu": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_75b231015bb20368c6df_kernel.cu",
                "sm_100a/cake_kda_chunk_train_75b231015bb20368c6df_binding.cu",
            ),
            "block": (192, 1, 1),
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_19070e33f884bc4f33bf_kernel.cu",
                "sm_103a/cake_kda_chunk_train_19070e33f884bc4f33bf_binding.cu",
            ),
            "block": (192, 1, 1),
            "dynamic_smem_bytes": 140288,
            "tma_workspace_bytes": 512,
    ...
    "dqkg": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_f4121c1ac1fcc00ddc64_kernel.cu",
                "sm_100a/cake_kda_chunk_train_f4121c1ac1fcc00ddc64_binding.cu",
            ),
            "block": (320, 1, 1),
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_20f35b9f77e23e9f5283_kernel.cu",
                "sm_103a/cake_kda_chunk_train_20f35b9f77e23e9f5283_binding.cu",
            ),
            "block": (320, 1, 1),
            "dynamic_smem_bytes": 174080,
            "tma_workspace_bytes": 896,
    ...
    "intra": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_8f902df21bdc21f29ba4_kernel.cu",
                "sm_100a/cake_kda_chunk_train_8f902df21bdc21f29ba4_binding.cu",
            ),
            "block": (256, 1, 1),
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_2b8071d9377000d0e36b_kernel.cu",
                "sm_103a/cake_kda_chunk_train_2b8071d9377000d0e36b_binding.cu",
            ),
            "block": (256, 1, 1),
            "dynamic_smem_bytes": 103680,
            "tma_workspace_bytes": 0,
    ...
    "gate_epilogue": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_0ad4626786c206c7f6d6_kernel.cu",
                "sm_100a/cake_kda_chunk_train_0ad4626786c206c7f6d6_binding.cu",
            ),
            "block": (1024, 1, 1),
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_34e0c3e6404417af0349_kernel.cu",
                "sm_103a/cake_kda_chunk_train_34e0c3e6404417af0349_binding.cu",
            ),
            "block": (1024, 1, 1),
            "dynamic_smem_bytes": 12288,
            "tma_workspace_bytes": 0,
    ...
    "qk_epilogue": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_d086ff5b482109313f4f_kernel.cu",
                "sm_100a/cake_kda_chunk_train_d086ff5b482109313f4f_binding.cu",
            ),
            "block": (256, 1, 1),
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_c05735dd9f5a1a7890f3_kernel.cu",
                "sm_103a/cake_kda_chunk_train_c05735dd9f5a1a7890f3_binding.cu",
            ),
            "block": (256, 1, 1),
            "dynamic_smem_bytes": 0,
            "tma_workspace_bytes": 0,
    ...
    "finalize": {
        "sm_100a": {
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_516c96214ba5df6fc734_kernel.cu",
                "sm_100a/cake_kda_chunk_train_516c96214ba5df6fc734_binding.cu",
            ),
            "block": (128, 1, 1),
        ...
        "sm_103a": {
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_93b2b013aa41ffaa96dc_kernel.cu",
                "sm_103a/cake_kda_chunk_train_93b2b013aa41ffaa96dc_binding.cu",
            ),
            "block": (128, 1, 1),
            "dynamic_smem_bytes": 128,
            "tma_workspace_bytes": 0,
