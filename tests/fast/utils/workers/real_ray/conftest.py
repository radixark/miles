...
class WorkerProbe:
    ...
    def launch_command(self, ctx: LaunchCommandContext) -> str:
        ...
        return shlex.join(
            [
                ...
                "-c",
                _PROBE_SOURCE,
                str(self.record_path(cell_id=ctx.cell_id, worker_in_cell_index=ctx.worker_in_cell_index)),
    ...
    def record_path(self, *, cell_id: str, worker_in_cell_index: int) -> Path:
        return Path(self.record_dir) / f"{cell_id}-{worker_in_cell_index}.json"
    ...
    def context_of(self, *, cell_id: str, worker_in_cell_index: int) -> dict[str, Any]:
        return self.read_records()[f"{cell_id}-{worker_in_cell_index}"]["context"]
