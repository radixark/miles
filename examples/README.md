...
- **[multi_lora_operations](./multi_lora_operations)**: Multi-adapter LoRA trained through explicit operations; stacked PR #2346 provides Tinker REST/SDK compatibility.
