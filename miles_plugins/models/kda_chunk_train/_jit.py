...
MODULES = {
    ...
    "dqkg": {
        "sm_100a": {
            "name": "cake_kda_chunk_train_cb2d20267f9e82f837b1",
            "arch": "sm_100a",
            "cache_name": "cake_kda_chunk_train_cb2d20267f9e82f837b1_sm_100a",
            "kernel_symbol": "kernel_cake_kda_chunk_train_cb2d20267f9e82f837b1",
            "arg_plan": (
                ("tma_buffer", "do_tma"),
                ("tma_buffer", "vn_tma"),
                ("tma_buffer", "dv2_tma"),
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_cb2d20267f9e82f837b1_kernel.cu",
                "sm_100a/cake_kda_chunk_train_cb2d20267f9e82f837b1_binding.cu",
            ),
            "block": (576, 1, 1),
            "dynamic_smem_bytes": 232192,
            "tma_workspace_bytes": 1280,
            "ffi_entry": "run",
            "compile_flags": ("--use_fast_math",),
        },
        "sm_103a": {
            "name": "cake_kda_chunk_train_4f5b04e348601d5945fa",
            "arch": "sm_103a",
            "cache_name": "cake_kda_chunk_train_4f5b04e348601d5945fa_sm_103a",
            "kernel_symbol": "kernel_cake_kda_chunk_train_4f5b04e348601d5945fa",
            "arg_plan": (
                ("tma_buffer", "do_tma"),
                ("tma_buffer", "vn_tma"),
                ("tma_buffer", "dv2_tma"),
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_4f5b04e348601d5945fa_kernel.cu",
                "sm_103a/cake_kda_chunk_train_4f5b04e348601d5945fa_binding.cu",
            ),
            "block": (576, 1, 1),
            "dynamic_smem_bytes": 232192,
            "tma_workspace_bytes": 1280,
    ...
    "intra_qk": {
        "sm_100a": {
            "name": "cake_kda_chunk_train_4e8343b3f3580cbb31c8",
            "arch": "sm_100a",
            "cache_name": "cake_kda_chunk_train_4e8343b3f3580cbb31c8_sm_100a",
            "kernel_symbol": "kernel_cake_kda_chunk_train_4e8343b3f3580cbb31c8",
            "arg_plan": (
                ("buffer", "dAqk"),
                ("buffer", "dAkk"),
                ("buffer", "gk"),
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_4e8343b3f3580cbb31c8_kernel.cu",
                "sm_100a/cake_kda_chunk_train_4e8343b3f3580cbb31c8_binding.cu",
            ),
            "block": (256, 1, 1),
            "dynamic_smem_bytes": 172288,
            "tma_workspace_bytes": 0,
            "ffi_entry": "run",
            "compile_flags": ("--use_fast_math",),
        },
        "sm_103a": {
            "name": "cake_kda_chunk_train_b24ed89e98812fde2dc1",
            "arch": "sm_103a",
            "cache_name": "cake_kda_chunk_train_b24ed89e98812fde2dc1_sm_103a",
            "kernel_symbol": "kernel_cake_kda_chunk_train_b24ed89e98812fde2dc1",
            "arg_plan": (
                ("buffer", "dAqk"),
                ("buffer", "dAkk"),
                ("buffer", "gk"),
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_b24ed89e98812fde2dc1_kernel.cu",
                "sm_103a/cake_kda_chunk_train_b24ed89e98812fde2dc1_binding.cu",
            ),
            "block": (256, 1, 1),
            "dynamic_smem_bytes": 172288,
            "tma_workspace_bytes": 0,
    ...
    "gate_epilogue": {
        "sm_100a": {
            "name": "cake_kda_chunk_train_aef5b5e9d5d1f6aa9271",
            "arch": "sm_100a",
            "cache_name": "cake_kda_chunk_train_aef5b5e9d5d1f6aa9271_sm_100a",
            "kernel_symbol": "kernel_cake_kda_chunk_train_aef5b5e9d5d1f6aa9271",
            "arg_plan": (
                ("buffer", "dg_intra"),
                ("buffer", "g_raw"),
                ("buffer", "db_total"),
            ...
            "sources": (
                "sm_100a/cake_kda_chunk_train_aef5b5e9d5d1f6aa9271_kernel.cu",
                "sm_100a/cake_kda_chunk_train_aef5b5e9d5d1f6aa9271_binding.cu",
            ),
            "block": (256, 1, 1),
        ...
        "sm_103a": {
            "name": "cake_kda_chunk_train_05551eb366d558dfe63f",
            "arch": "sm_103a",
            "cache_name": "cake_kda_chunk_train_05551eb366d558dfe63f_sm_103a",
            "kernel_symbol": "kernel_cake_kda_chunk_train_05551eb366d558dfe63f",
            "arg_plan": (
                ("buffer", "dg_intra"),
                ("buffer", "g_raw"),
                ("buffer", "db_total"),
            ...
            "sources": (
                "sm_103a/cake_kda_chunk_train_05551eb366d558dfe63f_kernel.cu",
                "sm_103a/cake_kda_chunk_train_05551eb366d558dfe63f_binding.cu",
            ),
            "block": (256, 1, 1),
            "dynamic_smem_bytes": 12288,
            "tma_workspace_bytes": 0,
