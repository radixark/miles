...
kernel_cake_kda_chunk_train_05551eb366d558dfe63f(float* __restrict__ dg_intra, __nv_bfloat16* __restrict__ g_raw, float* __restrict__ db_total, __nv_bfloat16* __restrict__ beta_raw, float* __restrict__ A_log, float* __restrict__ dt_bias, int* __restrict__ chunk_bos, int* __restrict__ chunk_len, __nv_bfloat16* __restrict__ dg_out, __nv_bfloat16* __restrict__ dbeta, float* __restrict__ dA_part, float* __restrict__ dbias_part, int num_heads, float lower_bound)
{
