...
class TestPerNodeClusterExecutor:
    def test_all_pass_returns_empty(self) -> None:
        ...
        bad_nodes = asyncio.run(executor.execute(node_agents=node_agents, timeout_seconds=30))
    ...
    def test_empty_agents_returns_empty(self) -> None:
        ...
        bad_nodes = asyncio.run(executor.execute(node_agents={}, timeout_seconds=30))
