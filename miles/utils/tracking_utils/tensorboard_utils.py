...
class _TensorboardAdapter(metaclass=SingletonMeta):
    ...
    def __init__(self, args):
        ...
        self.tb_dir=args.tb_dir if args.tb_dir is not None else "tensorboard_log"
    ...
    def _initialize(self, tb_project_name, tb_experiment_name):
        ...
        tensorboard_dir = os.environ.get("TENSORBOARD_DIR", f"{self.tb_dir}/{tb_project_name}/{tb_experiment_name}")
