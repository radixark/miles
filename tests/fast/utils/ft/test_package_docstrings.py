...
class TestDiagnosticsPackageDocstrings:
    ...
    def test_agents_diagnostics_has_docstring(self) -> None:
        assert agents_diag.__doc__ is not None, "agents/diagnostics/__init__.py should have a docstring"
        assert "node" in agents_diag.__doc__.lower()

    def test_controller_diagnostics_has_docstring(self) -> None:
        assert controller_diag.__doc__ is not None, "controller/diagnostics/__init__.py should have a docstring"
