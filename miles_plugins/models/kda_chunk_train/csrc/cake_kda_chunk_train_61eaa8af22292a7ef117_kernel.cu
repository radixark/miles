...
kernel_cake_kda_chunk_train_61eaa8af22292a7ef117(CakeTensorMap const* akk_tma, CakeTensorMap const* vb_tma, CakeTensorMap const* kb_tma, __nv_bfloat16* __restrict__ u_out, __nv_bfloat16* __restrict__ w_out, int num_heads)
{
