...
* [Unified FP8](/miles/docs/advanced/fp8-low-precision). Draft and target both quantized the
  same way.
* [INT4 QAT](/miles/docs/advanced/int4-qat). A quantized draft is cheaper to verify.
* [R3](/miles/docs/advanced/miles-router). R3 captures routing for the verified tokens emitted
  by the target.
