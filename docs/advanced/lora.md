...
| Bridge | GLM-5.3-Flash | Hybrid KDA + DSA MoE + mHC | [Launcher](https://github.com/radixark/miles/blob/main/scripts/run_glm5_3_flash_lora.py), [model page](/models/glm/glm5-3-flash) | KDA gate projections are new LoRA targets in SGLang and Megatron-Bridge; the DSA indexer is excluded; SGLang serves the FP8 checkpoint. |
