...
KNOWN_LABELS: dict[str, str] = {
    ...
    "ft-fast": "Fault-tolerance trainer comparison tests (no_failure / deterministic / with_failure)",
    "ft-slow": "Fault-tolerance trainer soak tests (random-crash survival, realistic-gsm8k convergence)",
