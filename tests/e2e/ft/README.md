...
- **Precise topology**: `--precise` adds `--update-weights-timeout 600`; `all_gather` sets trainer faults, and `p2p` sets the sender on a trainer-only mode and a receiver otherwise.
