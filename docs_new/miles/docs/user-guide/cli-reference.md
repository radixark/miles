...
See [Training Script Walkthrough: Colocation](/miles/docs/user-guide/training-script-walkthrough#colocation-share-gpus-or-dont)
...
| `--custom-rm-path` | str | – | Custom reward function (see [Customization](/miles/docs/user-guide/customization)). |
