...
* [R3](miles-router). Keeps MoE routing stable across the quantized forward.
* [P2P weight transfer](p2p-weight-transfer). INT4 weights are 4× smaller,
  so weight sync transfers less data.
* [Speculative decoding](speculative-decoding). Compounds for end-to-end
  rollout speedup.
