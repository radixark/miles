...
[Installation](/diffusion/getting-started/installation) already builds from
...
- [LoRA Training and Weight Sync](/diffusion/advanced/lora) — the IPC merge this recipe requires.
