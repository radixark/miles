...
kernel_cake_dsa_train_4809e4de8b70dccfdcff(__nv_bfloat16* __restrict__ q, __nv_bfloat16* __restrict__ kv, float* __restrict__ sink, int* __restrict__ indices, __nv_bfloat16* __restrict__ out, float* __restrict__ lse, int heads, int topk, float scale_log2)
{
    ...
    __nv_bfloat16* s_kv = reinterpret_cast<__nv_bfloat16*>(smem_raw + 32768);
    const int s_kv_addr = smem + 32768;
    __nv_bfloat16* s_p = reinterpret_cast<__nv_bfloat16*>(smem_raw + 98304);
    const int s_p_addr = smem + 98304;
    int* s_idx = reinterpret_cast<int*>(smem_raw + 102400);
    const int s_idx_addr = smem + 102400;
    float* s_red = reinterpret_cast<float*>(smem_raw + 102656);
    const int s_red_addr = smem + 102656;
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_q_addr + (unsigned int)((128 + tid) % 64 * 8 / 64 * 4096 + ((128 + tid) / 64 * 128 + (128 + tid) % 64 * 8 % 64 * 2 ^ ((128 + tid) / 64 * 128 + (128 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(q + (((long long)row * (long long)heads + (long long)(h0 + (128 + tid) / 64)) * 512 + (long long)((128 + tid) % 64 * 8))), "r"((h0 + (128 + tid) / 64 < heads) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_q_addr + (unsigned int)((384 + tid) % 64 * 8 / 64 * 4096 + ((384 + tid) / 64 * 128 + (384 + tid) % 64 * 8 % 64 * 2 ^ ((384 + tid) / 64 * 128 + (384 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(q + (((long long)row * (long long)heads + (long long)(h0 + (384 + tid) / 64)) * 512 + (long long)((384 + tid) % 64 * 8))), "r"((h0 + (384 + tid) / 64 < heads) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_q_addr + (unsigned int)((640 + tid) % 64 * 8 / 64 * 4096 + ((640 + tid) / 64 * 128 + (640 + tid) % 64 * 8 % 64 * 2 ^ ((640 + tid) / 64 * 128 + (640 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(q + (((long long)row * (long long)heads + (long long)(h0 + (640 + tid) / 64)) * 512 + (long long)((640 + tid) % 64 * 8))), "r"((h0 + (640 + tid) / 64 < heads) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_q_addr + (unsigned int)((896 + tid) % 64 * 8 / 64 * 4096 + ((896 + tid) / 64 * 128 + (896 + tid) % 64 * 8 % 64 * 2 ^ ((896 + tid) / 64 * 128 + (896 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(q + (((long long)row * (long long)heads + (long long)(h0 + (896 + tid) / 64)) * 512 + (long long)((896 + tid) % 64 * 8))), "r"((h0 + (896 + tid) / 64 < heads) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_q_addr + (unsigned int)((1152 + tid) % 64 * 8 / 64 * 4096 + ((1152 + tid) / 64 * 128 + (1152 + tid) % 64 * 8 % 64 * 2 ^ ((1152 + tid) / 64 * 128 + (1152 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(q + (((long long)row * (long long)heads + (long long)(h0 + (1152 + tid) / 64)) * 512 + (long long)((1152 + tid) % 64 * 8))), "r"((h0 + (1152 + tid) / 64 < heads) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_q_addr + (unsigned int)((1408 + tid) % 64 * 8 / 64 * 4096 + ((1408 + tid) / 64 * 128 + (1408 + tid) % 64 * 8 % 64 * 2 ^ ((1408 + tid) / 64 * 128 + (1408 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(q + (((long long)row * (long long)heads + (long long)(h0 + (1408 + tid) / 64)) * 512 + (long long)((1408 + tid) % 64 * 8))), "r"((h0 + (1408 + tid) / 64 < heads) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_q_addr + (unsigned int)((1664 + tid) % 64 * 8 / 64 * 4096 + ((1664 + tid) / 64 * 128 + (1664 + tid) % 64 * 8 % 64 * 2 ^ ((1664 + tid) / 64 * 128 + (1664 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(q + (((long long)row * (long long)heads + (long long)(h0 + (1664 + tid) / 64)) * 512 + (long long)((1664 + tid) % 64 * 8))), "r"((h0 + (1664 + tid) / 64 < heads) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_q_addr + (unsigned int)((1920 + tid) % 64 * 8 / 64 * 4096 + ((1920 + tid) / 64 * 128 + (1920 + tid) % 64 * 8 % 64 * 2 ^ ((1920 + tid) / 64 * 128 + (1920 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(q + (((long long)row * (long long)heads + (long long)(h0 + (1920 + tid) / 64)) * 512 + (long long)((1920 + tid) % 64 * 8))), "r"((h0 + (1920 + tid) / 64 < heads) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_kv_addr + (unsigned int)((128 + tid) % 64 * 8 / 64 * 4096 + ((128 + tid) / 64 * 128 + (128 + tid) % 64 * 8 % 64 * 2 ^ ((128 + tid) / 64 * 128 + (128 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[(128 + tid) / 64] * 512 + (long long)((128 + tid) % 64 * 8))), "r"((s_idx[(128 + tid) / 64] >= 0) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_kv_addr + (unsigned int)((384 + tid) % 64 * 8 / 64 * 4096 + ((384 + tid) / 64 * 128 + (384 + tid) % 64 * 8 % 64 * 2 ^ ((384 + tid) / 64 * 128 + (384 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[(384 + tid) / 64] * 512 + (long long)((384 + tid) % 64 * 8))), "r"((s_idx[(384 + tid) / 64] >= 0) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_kv_addr + (unsigned int)((640 + tid) % 64 * 8 / 64 * 4096 + ((640 + tid) / 64 * 128 + (640 + tid) % 64 * 8 % 64 * 2 ^ ((640 + tid) / 64 * 128 + (640 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[(640 + tid) / 64] * 512 + (long long)((640 + tid) % 64 * 8))), "r"((s_idx[(640 + tid) / 64] >= 0) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_kv_addr + (unsigned int)((896 + tid) % 64 * 8 / 64 * 4096 + ((896 + tid) / 64 * 128 + (896 + tid) % 64 * 8 % 64 * 2 ^ ((896 + tid) / 64 * 128 + (896 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[(896 + tid) / 64] * 512 + (long long)((896 + tid) % 64 * 8))), "r"((s_idx[(896 + tid) / 64] >= 0) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_kv_addr + (unsigned int)((1152 + tid) % 64 * 8 / 64 * 4096 + ((1152 + tid) / 64 * 128 + (1152 + tid) % 64 * 8 % 64 * 2 ^ ((1152 + tid) / 64 * 128 + (1152 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[(1152 + tid) / 64] * 512 + (long long)((1152 + tid) % 64 * 8))), "r"((s_idx[(1152 + tid) / 64] >= 0) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_kv_addr + (unsigned int)((1408 + tid) % 64 * 8 / 64 * 4096 + ((1408 + tid) / 64 * 128 + (1408 + tid) % 64 * 8 % 64 * 2 ^ ((1408 + tid) / 64 * 128 + (1408 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[(1408 + tid) / 64] * 512 + (long long)((1408 + tid) % 64 * 8))), "r"((s_idx[(1408 + tid) / 64] >= 0) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_kv_addr + (unsigned int)((1664 + tid) % 64 * 8 / 64 * 4096 + ((1664 + tid) / 64 * 128 + (1664 + tid) % 64 * 8 % 64 * 2 ^ ((1664 + tid) / 64 * 128 + (1664 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[(1664 + tid) / 64] * 512 + (long long)((1664 + tid) % 64 * 8))), "r"((s_idx[(1664 + tid) / 64] >= 0) ? 16 : 0));
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
    ...
    asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
        :: "r"(s_kv_addr + (unsigned int)((1920 + tid) % 64 * 8 / 64 * 4096 + ((1920 + tid) / 64 * 128 + (1920 + tid) % 64 * 8 % 64 * 2 ^ ((1920 + tid) / 64 * 128 + (1920 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[(1920 + tid) / 64] * 512 + (long long)((1920 + tid) % 64 * 8))), "r"((s_idx[(1920 + tid) / 64] >= 0) ? 16 : 0));
    ...
    for (int blk = 0; blk < num_blocks; blk++) {
        ...
        if (num_blocks > blk + 1) {
            ...
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
                :: "r"(s_kv_addr + (unsigned int)(nst * 32768) + (unsigned int)((128 + tid) % 64 * 8 / 64 * 4096 + ((128 + tid) / 64 * 128 + (128 + tid) % 64 * 8 % 64 * 2 ^ ((128 + tid) / 64 * 128 + (128 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[nst * 32 + (128 + tid) / 64] * 512 + (long long)((128 + tid) % 64 * 8))), "r"((s_idx[nst * 32 + (128 + tid) / 64] >= 0) ? 16 : 0));
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
            ...
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
                :: "r"(s_kv_addr + (unsigned int)(nst * 32768) + (unsigned int)((384 + tid) % 64 * 8 / 64 * 4096 + ((384 + tid) / 64 * 128 + (384 + tid) % 64 * 8 % 64 * 2 ^ ((384 + tid) / 64 * 128 + (384 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[nst * 32 + (384 + tid) / 64] * 512 + (long long)((384 + tid) % 64 * 8))), "r"((s_idx[nst * 32 + (384 + tid) / 64] >= 0) ? 16 : 0));
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
            ...
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
                :: "r"(s_kv_addr + (unsigned int)(nst * 32768) + (unsigned int)((640 + tid) % 64 * 8 / 64 * 4096 + ((640 + tid) / 64 * 128 + (640 + tid) % 64 * 8 % 64 * 2 ^ ((640 + tid) / 64 * 128 + (640 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[nst * 32 + (640 + tid) / 64] * 512 + (long long)((640 + tid) % 64 * 8))), "r"((s_idx[nst * 32 + (640 + tid) / 64] >= 0) ? 16 : 0));
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
            ...
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
                :: "r"(s_kv_addr + (unsigned int)(nst * 32768) + (unsigned int)((896 + tid) % 64 * 8 / 64 * 4096 + ((896 + tid) / 64 * 128 + (896 + tid) % 64 * 8 % 64 * 2 ^ ((896 + tid) / 64 * 128 + (896 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[nst * 32 + (896 + tid) / 64] * 512 + (long long)((896 + tid) % 64 * 8))), "r"((s_idx[nst * 32 + (896 + tid) / 64] >= 0) ? 16 : 0));
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
            ...
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
                :: "r"(s_kv_addr + (unsigned int)(nst * 32768) + (unsigned int)((1152 + tid) % 64 * 8 / 64 * 4096 + ((1152 + tid) / 64 * 128 + (1152 + tid) % 64 * 8 % 64 * 2 ^ ((1152 + tid) / 64 * 128 + (1152 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[nst * 32 + (1152 + tid) / 64] * 512 + (long long)((1152 + tid) % 64 * 8))), "r"((s_idx[nst * 32 + (1152 + tid) / 64] >= 0) ? 16 : 0));
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
            ...
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
                :: "r"(s_kv_addr + (unsigned int)(nst * 32768) + (unsigned int)((1408 + tid) % 64 * 8 / 64 * 4096 + ((1408 + tid) / 64 * 128 + (1408 + tid) % 64 * 8 % 64 * 2 ^ ((1408 + tid) / 64 * 128 + (1408 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[nst * 32 + (1408 + tid) / 64] * 512 + (long long)((1408 + tid) % 64 * 8))), "r"((s_idx[nst * 32 + (1408 + tid) / 64] >= 0) ? 16 : 0));
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
            ...
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
                :: "r"(s_kv_addr + (unsigned int)(nst * 32768) + (unsigned int)((1664 + tid) % 64 * 8 / 64 * 4096 + ((1664 + tid) / 64 * 128 + (1664 + tid) % 64 * 8 % 64 * 2 ^ ((1664 + tid) / 64 * 128 + (1664 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[nst * 32 + (1664 + tid) / 64] * 512 + (long long)((1664 + tid) % 64 * 8))), "r"((s_idx[nst * 32 + (1664 + tid) / 64] >= 0) ? 16 : 0));
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
            ...
            asm volatile("cp.async.cg.shared::cta.global [%0], [%1], 16, %2;"
                :: "r"(s_kv_addr + (unsigned int)(nst * 32768) + (unsigned int)((1920 + tid) % 64 * 8 / 64 * 4096 + ((1920 + tid) / 64 * 128 + (1920 + tid) % 64 * 8 % 64 * 2 ^ ((1920 + tid) / 64 * 128 + (1920 + tid) % 64 * 8 % 64 * 2 >> 7 & 7) << 4))), "l"(kv + ((long long)s_idx[nst * 32 + (1920 + tid) / 64] * 512 + (long long)((1920 + tid) % 64 * 8))), "r"((s_idx[nst * 32 + (1920 + tid) / 64] >= 0) ? 16 : 0));
            asm volatile("cp.async.commit_group;");
