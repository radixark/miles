...
def _init_wandb_common():
    ...
    wandb.define_metric("rollout/response_len/*", step_metric="rollout/step")
    wandb.define_metric("rollout/zero_std/*", step_metric="rollout/step")
    wandb.define_metric("rollout/weight_version/*", step_metric="rollout/step")
    wandb.define_metric("rollout/tito_session_mismatch_rate/*", step_metric="rollout/step")
    wandb.define_metric("rollout/error_cat/*", step_metric="rollout/step")
    wandb.define_metric("rollout/dynamic_filter/*", step_metric="rollout/step")
    # wandb.define_metric("session/step")
    # wandb.define_metric("session/*", step_metric="session/step")
    wandb.define_metric("multi_turn/*", step_metric="rollout/step")
    wandb.define_metric("multi_turn/raw_response_length/*", step_metric="rollout/step")
    wandb.define_metric("multi_turn/wo_obs_response_length/*", step_metric="rollout/step")
    wandb.define_metric("multi_turn/multi_turn_metric/*", step_metric="rollout/step")
    wandb.define_metric("passrate/*", step_metric="rollout/step")
    wandb.define_metric("eval/step")
    wandb.define_metric("eval/*", step_metric="eval/step")
    wandb.define_metric("eval/*/response_len/*", step_metric="eval/step")
    wandb.define_metric("eval/*/zero_std/*", step_metric="eval/step")
    wandb.define_metric("eval/*/weight_version/*", step_metric="eval/step")
    wandb.define_metric("eval/*/tito_session_mismatch_rate/*", step_metric="eval/step")
    wandb.define_metric("eval/*/error_cat/*", step_metric="eval/step")
    wandb.define_metric("perf/*", step_metric="rollout/step")
    wandb.define_metric("perf/non_generation_time/*", step_metric="rollout/step")
