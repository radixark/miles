...
Each model name links to its recipe page. JoyAI-LLM-Flash has a launch script but no
recipe page yet, so it links to the script.
...
| **Gemma** | [Gemma-4 26B-A4B / 31B](/models/gemma/gemma-4) |
