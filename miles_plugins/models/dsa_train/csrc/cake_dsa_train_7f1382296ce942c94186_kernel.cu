...
kernel_cake_dsa_train_7f1382296ce942c94186(float* __restrict__ partial, int* __restrict__ order, int* __restrict__ seg_start, int* __restrict__ seg_count, float* __restrict__ out, int dim, int keys_per_cta, int num_out)
{
