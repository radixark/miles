...
from miles.utils.dumper_utils import DumperPhase, DumperPhaseContext
...
def forward_only(
    ...
    dumper_phase = DumperPhaseContext(args, DumperPhase.FWD_ONLY)
    ...
    config.timers = None
    forward_step = dumper_phase.wrap_forward_step(forward_step)
    forward_data_store = []
...
def train_one_step(
    ...
    """
    args = get_args()
    dumper_phase = DumperPhaseContext(args, DumperPhase.FWD_BWD)
