...
kernel_cake_kda_chunk_train_d155f4149e31d96da0b0(CakeTensorMap const* w_tma, CakeTensorMap const* kg_tma, __nv_bfloat16* __restrict__ u, float* __restrict__ gk, __nv_bfloat16* __restrict__ h_out, __nv_bfloat16* __restrict__ v_new, int num_heads, int* __restrict__ seq_chunk_start)
{
