...
kernel_cake_kda_chunk_train_eeab91af7e13dac4193a(float* __restrict__ dA_part, float* __restrict__ dbias_part, float* __restrict__ dA_log, float* __restrict__ dt_bias_grad, int num_chunks, int num_heads)
{
