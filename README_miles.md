...
[![Documentation](https://img.shields.io/badge/docs-latest-brightgreen.svg?style=flat)](https://thudm.github.io/miles/)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/radixark/miles)
...
miles is the RL-framework behind [GLM-4.5](https://z.ai/blog/glm-4.5) and [GLM-4.6](https://z.ai/blog/glm-4.6) and apart from models from Z.ai, we also supports the following models:
...
- Our vision: [miles: An SGLang-Native Post-Training Framework for RL Scaling](https://lmsys.org/blog/2025-07-09-miles/).
...
- v0.1.0 release note: [v0.1.0: Redefining High-Performance RL Training Frameworks](https://thudm.github.io/miles/blogs/release_v0.1.0.html)

## Table of Contents

- [Architecture Overview](#architecture-overview)
- [Quick Start](#quick-start)
- [Projects Built with miles](#projects-built-with-miles)
...
3.  **miles-specific arguments**: Please refer to: [miles/utils/arguments.py](miles/utils/arguments.py)
...
- To quote miles, please use:

```bibtext
@misc{miles_github,
  author       = {Zilin Zhu and Chengxing Xie and Xin Lv and miles Contributors},
  title        = {miles: An LLM post-training framework for RL Scaling},
  year         = {2025},
