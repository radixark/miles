...
class ServerCell:
    ...
    def _spec_name(self) -> str:
        return compute_engine_spec_name(model_idx=self.model_idx, group_index=self.group_index)
    ...
    async def start_engines(self) -> None:
        ...
        worker_name = compute_worker_name(spec_name=self._spec_name, cell_index=self.cell_index)
