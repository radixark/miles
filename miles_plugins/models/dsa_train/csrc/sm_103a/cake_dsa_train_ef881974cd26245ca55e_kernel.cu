...
kernel_cake_dsa_train_ef881974cd26245ca55e(__nv_bfloat16* __restrict__ index_q, __nv_bfloat16* __restrict__ index_k, float* __restrict__ weights, int* __restrict__ cu_ks, int* __restrict__ cu_ke, float* __restrict__ logits, int seq_len, int seq_len_kv)
{
