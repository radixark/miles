...
def _get_responses_with_indices(
    logits: torch.Tensor,
    *,
    args: Namespace,
    ...
    Yields:
        ...
        local row back to the full response.
    """
    ...
    for i, (tokens, total_length, response_length) in enumerate(
        ...
        if cp_size == 1:
            ...
            response_indices = range(response_length)
...
def get_responses(
    ...
    *,
    ...
    for logits_chunk, tokens_chunk, _ in _get_responses_with_indices(
        logits,
        args=args,
...
def get_log_probs_and_entropy(
    ...
    *,
    ...
    log_probs_list = []
    entropy_list = []
    response_chunks = _get_responses_with_indices(
        logits,
        args=args,
        unconcat_tokens=unconcat_tokens,
        total_lengths=total_lengths,
