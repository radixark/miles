...
<CardGroup cols={2}>
  ...
  <Card title="Low Precision RL" icon="bolt" href="/miles/docs/advanced/fp8-low-precision">
  ...
  <Card title="INT4 QAT" icon="microchip" href="/miles/docs/advanced/int4-qat">
  ...
  <Card title="Rollout Routing Replay (R3)" icon="network-wired" href="/miles/docs/advanced/miles-router">
  ...
  <Card title="Speculative Decoding" icon="rocket" href="/miles/docs/advanced/speculative-decoding">

    Draft + target speculative rollout, with online MTP-SFT for the draft.

  </Card>

  <Card title="LoRA Training and Serving" icon="sliders" href="/miles/docs/advanced/lora">
