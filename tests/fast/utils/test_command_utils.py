...
class TestExecuteTrain:
    ...
    def test_scoped_supervisor_can_skip_process_name_cleanup(self, commands, monkeypatch):
        monkeypatch.setenv("MILES_SCRIPT_EXTERNAL_RAY", "1")
        command_utils.execute_train(
            train_args="", num_gpus_per_node=8, megatron_model_type="qwen3-4B", cleanup_processes=False
        )
