        ...
        with _patch_build_and_run() as (mock_actor_cls, _):
            result = runner.invoke(
                ...
                [
                    ...
                    "--platform",
                    "stub",
                    "--mini-prometheus-retention-minutes",
                    "120",
                    "--",
                    "python3",
                    "train.py",
        ...
        with _patch_build_and_run() as (mock_actor_cls, _):
            result = runner.invoke(
                ...
                [
                    ...
                    "--platform",
                    "stub",
                    "--recovery-cooldown-window-minutes",
                    "60",
                    "--recovery-cooldown-max-count",
                    "5",
                    "--registration-grace-ticks",
                    "10",
                    "--max-simultaneous-bad-nodes",
                    "2",
                    "--monitoring-success-iterations",
                    "20",
                    "--monitoring-timeout-seconds",
                    "1200",
                    "--recovery-timeout-seconds",
                    "7200",
                    "--rollout-alive-threshold-seconds",
                    "30",
                    "--rollout-monitoring-alive-duration-seconds",
                    "300",
                    "--",
                    "python3",
                    "train.py",
        ...
        with _patch_build_and_run() as (mock_actor_cls, _):
            result = runner.invoke(
                ...
                [
                    ...
                    "--platform",
                    "stub",
                    "--ray-job-poll-interval-seconds",
                    "10",
                    "--ray-submit-timeout-seconds",
                    "120",
                    "--ray-get-status-timeout-seconds",
                    "60",
                    "--ray-stop-job-timeout-seconds",
                    "45",
                    "--",
                    "python3",
                    "train.py",
        ...
        with _patch_build_and_run() as (mock_actor_cls, _):
            result = runner.invoke(
                ...
                [
                    ...
                    "--notify-max-retries",
                    "5",
                    "--notify-initial-backoff-seconds",
                    "2",
                    "--",
                    "python3",
                    "train.py",
