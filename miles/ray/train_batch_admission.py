...
The manager owns publication settlement.  Trainer adapters only prove that the
exact published object-store references are readable and return an immutable
cohort pin for the later training lifecycle.
"""
