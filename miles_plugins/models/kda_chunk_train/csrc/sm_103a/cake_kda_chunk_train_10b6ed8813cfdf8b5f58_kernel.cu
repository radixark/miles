...
kernel_cake_kda_chunk_train_10b6ed8813cfdf8b5f58(CakeTensorMap const* akk_tma, CakeTensorMap const* vb_tma, CakeTensorMap const* kb_tma, __nv_bfloat16* __restrict__ u_out, __nv_bfloat16* __restrict__ w_out, int num_heads)
{
