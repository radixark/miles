...
| Bridge | GLM-5.3 744B-A40B | MoE + MLA + DSA | [GLM-5.3 recipe](/models/glm/glm5-3), select `--model-name GLM-5.3` in the GLM-5.2 launcher | Uses the same architecture; BF16 trainer and optional official FP8 rollout. See the recipe for validation scope. |
