...
def _serve_router(extra_args: dict | None = None):
    ...
    with with_mock_server(process_fn=process_fn) as backend:
        args_values = {
            ...
            "session_sample_picker_path": "miles.rollout.session.v2.picker_hub.drop_retries_same_prompt",
...
def test_concurrent_requests_from_same_parent_commit_siblings():
    ...
    picker_path = "miles.rollout.session.v2.picker_hub.drop_retries_same_prompt"
