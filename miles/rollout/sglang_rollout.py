...
async def abort(args: Namespace, rollout_id: int) -> list[list[Sample]]:
    ...
    while state.pendings:
        ...
        if not args.partial_rollout:
            ...
            SampleOwnershipRecorder.log_dropped_groups(groups, [], reason="abort", rollout_id=rollout_id)
            continue
...
async def generate_rollout_async(
    ...
    while len(data) < target_data_size:
        ...
        for task in done:
            ...
            if len(data) < target_data_size:
                ...
                SampleOwnershipRecorder.log_dropped_groups(group, [], reason="oversampling", rollout_id=rollout_id)
    ...
    if (x := args.rollout_sample_filter_path) is not None:
        ...
        SampleOwnershipRecorder.log_dropped_groups(before_filter, data, reason="sample_filter", rollout_id=rollout_id)
