...
# tests/e2e/ft/conftest_ft/scenario_precise_all_gather_mixed.py.

from tests.ci.ci_register import register_cuda_ci
from tests.e2e.ft.conftest_ft.scenario_precise_all_gather_mixed import run_ci

register_cuda_ci(
    est_time=4800,
    suite="stage-c-8-gpu-h200",
    labels=["ft-long", "weight-update"],
