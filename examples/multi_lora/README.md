...
service = tinker.ServiceClient(base_url="http://127.0.0.1:10613", api_key="tml-my-tenant")
training = service.create_lora_training_client(base_model="/root/models/Qwen3-30B-A3B", rank=32, train_unembed=False)
```
