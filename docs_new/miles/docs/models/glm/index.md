...
|---|---|---|---|
| GLM4 | Dense | 9 B · 32 B | [glm4](glm4) |
| GLM4.5 | MoE | 12 B / 106 B · 32 B / 355 B | [glm4-5](glm4-5) |
| GLM4.7 Flash | MoE (64 experts, top-4) | Compact | [glm4-7-flash](glm4-7-flash) |
| GLM5 | MoE | 40 B / 744 B | [glm5](glm5) |
...
See the [GLM4 Dense](glm4) page for weight conversion and the full walkthrough.

## Which variant do I pick?

- **Single-node GLM first try** → GLM4-9B ([glm4](glm4)).
- **Larger dense** → GLM4-32B ([glm4](glm4)).
- **MoE on a budget** → GLM4.5-106B-A12B ([glm4-5](glm4-5)).
- **Full MoE scale (multi-node)** → GLM4.5-355B-A32B ([glm4-5](glm4-5)).
- **Compact MoE for routing experiments (R3)** → GLM4.7 Flash ([glm4-7-flash](glm4-7-flash)).
- **Frontier scale (744 B)** → GLM5 ([glm5](glm5)).
