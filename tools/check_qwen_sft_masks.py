...
def _check_row(payload: tuple[int, dict, str]) -> dict:
    ...
    reference = tokenizer.apply_chat_template(messages, tools=tools, preserve_thinking=True, tokenize=True, return_dict=False)
...
def main() -> None:
    ...
    result = {"rows": 0, "accepted": 0, "rendered_tokens": 0, "target_tokens": 0, "max_tokens": 0, "rows_with_tools": 0, "explicit_masks": 0, "failures": [], "by_source": {}}
