...
#   # ... more training code ...
#   profiler.mark("step_0/train_end")
#   profiler.stop()  # dumps CSV with columns: time_s, used_gb, available_gb, percent, marker
...
class CPUMemoryProfiler:
    ...
    def mark(self, label: str):
        """Place a named marker on the timeline for phase alignment."""
        with self._lock:
