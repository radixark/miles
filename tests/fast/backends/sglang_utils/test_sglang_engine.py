...
class TestComputeEngineLaunchCmd:
    ...
    def test_the_seed_is_derived_from_the_launch_arguments(self):
        """Leaving it to sglang makes two runs of the same launch sample different continuations,
        so a seed-pinned comparison stops being a comparison."""
    ...
    def test_two_engines_of_one_run_do_not_share_a_seed(self):
