...
class ScriptArgs(U.ExecuteTrainConfig):
    mode: Literal["normal", "debug_rollout_only","debug_train_only"] = "debug_rollout_only"
    ...
    data_name: str = "swegym_qwen3.5-27b-fp8_reward1_submitted"
...
def execute(args: ScriptArgs):
    ...
    if args.mode == "debug_rollout_only":
        ...
        "/fs/nlp-intern/yangchengyi/trajs/swegym_qwen3.5-27b-fp8_reward1_submitted_Qwen3.5-27B_agentic_async_debug_session_over_sample_20260605_004811/rollout_data/0.pt "
    )
    wandb_args = ""
    if args.wandb_key:
        wandb_args = (
