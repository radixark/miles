...
class TestOwnedMooncakeMaster:
    ...
    def test_an_environment_master_disables_local_startup_despite_explicit_arguments(
        self, monkeypatch: pytest.MonkeyPatch
    ) -> None:
        """An environment master prevents local startup even with an explicit local endpoint."""
        monkeypatch.setenv("MOONCAKE_MASTER", "store.example:61234")
