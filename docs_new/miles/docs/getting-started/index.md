...
- **[Installation](installation)** — Docker (recommended), pip, or building from source on NVIDIA / AMD.
- **[Quick Start](quick-start)** — `docker pull` to a GRPO run on Qwen3-4B in under an hour, on a single 8-GPU node.
