...
kernel_cake_kda_chunk_train_895185f20c4f0c47d54e(CakeTensorMap const* kg_tma, CakeTensorMap const* qg_tma, CakeTensorMap const* w_tma, CakeTensorMap const* do_tma, __nv_bfloat16* __restrict__ dv1, float* __restrict__ gk, __nv_bfloat16* __restrict__ dh_out, __nv_bfloat16* __restrict__ dv2, int num_heads, int* __restrict__ seq_chunk_start, float scale)
{
