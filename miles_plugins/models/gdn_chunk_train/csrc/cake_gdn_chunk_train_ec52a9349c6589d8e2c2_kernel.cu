...
kernel_cake_gdn_chunk_train_ec52a9349c6589d8e2c2(__nv_bfloat16* __restrict__ qn, __nv_bfloat16* __restrict__ kn, __nv_bfloat16* __restrict__ do_, float* __restrict__ g_cs, __nv_bfloat16* __restrict__ dv_local, int* __restrict__ chunk_start, int* __restrict__ chunk_len, int num_heads, int num_v_heads, float scale)
{
