...
class TestAgentManagement:
    def test_register_agent_adds_to_dict(self) -> None:
        ...
        assert "node-0" in harness.controller._node_agents
        assert harness.controller._node_agents["node-0"] is agent
    ...
    def test_register_overwrites_existing(self) -> None:
        ...
        assert harness.controller._node_agents["node-0"] is agent2
