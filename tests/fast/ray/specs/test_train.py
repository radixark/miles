...
class TestScheduling:
    ...
    def test_a_cell_spanning_several_nodes_is_deployed_as_one_pod_per_node(self):
        ...
        assert (spec.scheduling.pods_per_cell(), spec.scheduling.ranks_per_pod()) == (2, 8)
    ...
    def test_each_role_packs_its_pods_with_its_own_per_node_count(self):
        ...
        assert (actor_spec.scheduling.ranks_per_pod(), critic_spec.scheduling.ranks_per_pod()) == (8, 2)
    ...
    def test_a_cell_smaller_than_a_node_fits_into_one_pod(self, monkeypatch):
        ...
        assert (spec.scheduling.pods_per_cell(), spec.scheduling.ranks_per_pod()) == (1, 2)
