...
from miles.utils.dumper_utils import DumperPhase, DumperPhaseUtil
...
def forward_only(
    ...
    dumper_phase_util = DumperPhaseUtil(args, DumperPhase.FWD_ONLY)
...
def train_one_step(
    ...
    """
    args = get_args()
    dumper_phase_util = DumperPhaseUtil(args, DumperPhase.FWD_BWD)
