...
class ServerCell:
    ...
    def _spec_name(self) -> str:
        return compute_engine_spec_name(model_idx=self.meta.model_idx, group_index=self.meta.group_index)
    ...
    async def _add_raw(self) -> None:
        ...
        worker_name = compute_worker_name(spec_name=self._spec_name, cell_index=self.meta.cell_index)
